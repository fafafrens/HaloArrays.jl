...
function main()
    ...
    run_heatbath!(local_phi, heatbath_rng(local_phi, 1234), p; sweeps)
    print_observables("LocalHaloArray", local_phi, observables(local_phi))
    ...
    print_observables("ThreadedHaloArray", threaded_phi, observables(threaded_phi))
