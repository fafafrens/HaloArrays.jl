...
# include i file del progetto (boundary deve venire prima di haloarray)
...
include("interior_broadcast_maybe.jl")   # definisce similar/copy/materialize per MaybeHaloArray
